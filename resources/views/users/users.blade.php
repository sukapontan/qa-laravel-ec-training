...
<div class="row mb-5 h4">
    ...
    <p><span>〒</span>{{ $user->zipcode }}</p>
    <p>{{ $user->prefecture }} {{ $user->manicipality }} {{ $user->address }} {{ $user->apartments }}</p>
    </div>
</div>
<div class="row mb-5 h4">
...
<div class="text-center col-auto px-3 my-3">
    <a href="{{ route('users.edit', auth()->user()->id) }}" class="btn btn-primary col-auto">修正/退会する</a>
</div>
</div>
